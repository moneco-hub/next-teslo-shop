...
const LoginPage: NextPage = () => {
  ...
  return (
    <AuthLayout title="login">
      <form onSubmit={handleSubmit(onLoginUser)} noValidate autoComplete="off">
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                {...register("password", {
                  required: "This field is required",
                  minLength: { value: 6, message: "You must provide 6 characters" },
                })}
            ...
            <Grid item xs={12} display="flex" justifyContent="end">
              <NextLink href={`/auth/register?p=${router.query.p?.toString() || "/"}`} passHref>
                <Link underline="always">¿Do not you have an account?</Link>
              </NextLink>
            </Grid>
